...
# Load the data
data = pd.read_csv('C:/Users/bencr/Downloads/combined_collision_v3/accidents_summary.csv')
...
print("The result has been saved to 'accidents_summary_with_mean_severity.csv'.")